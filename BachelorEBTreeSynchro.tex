...
%TODO quroum 2/3 knoten erhalten paket antwort an client erfolgreich else unerfolgreich rest kann verloren gehen aber durch synchro einfuegen sicher gestellt
...
\end{description}
Synchro startet Random , anzahl an werten 100,1000,.... %TODO
SynchroPkt size
DataSize
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
    \includegraphics[width=1.0\linewidth]{bilder/BarEmptyDbSync.png}
  \end{center}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
    \includegraphics[width=1.0\linewidth]{bilder/BarDBDiff.png}
  \end{center}
 \caption{Versandte Synchronisationspakete pro Synchronisationszyklus}
  \label{fig:EmptyDBTraffic}
\end{wrapfigure}
...
gesucht Verhältnis
sync ops frequency		
%---------------------------------------------------------------------------------------------------------------------------------------------------	entzuendung schlimmer	-> kann abens finger nur eingeschränk bewegen, schmerzen in der hand, medikamente schlagen auf den magen, 
